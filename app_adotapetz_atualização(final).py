...
class AdotaPetzApp:
    def __init__(self, root):
        ...
        self.root.geometry("1000x700")  # Aumentei o tamanho para acomodar mais informações
    ...
    def mostrar_acompanhamento(self):
        ...
        if self.usuario_logado.get('tipo') == 'admin':
            ...
            ttk.Label(self.main_frame, text="VISÃO DO ADMINISTRADOR - TODAS AS ADOÇÕES", style='Title.TLabel', foreground='red').pack(pady=10)
        else:
        ...
        if not minhas_adocoes:
            ttk.Label(self.main_frame, text="Nenhuma adoção registrada.").pack(pady=20)
        else:
            for adocao in minhas_adocoes:
                ...
                # Mostrar informações detalhadas do animal
